...
//    }
// Random:    
//    var colors = [getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor(), getRandomColor()];
// Pastel:
    ...
    function drawPart(data, id, p) {
        ...
        mainbar.append("text").attr("class", "barpercent")
            ...
            return d.middle + 5;
                ...
                .text(function (d, i) {
                    var calc = (100 * d.percent).toFixed(2);
                    return "( " + calc + "%)";
                })
            ...
            [0, 1].forEach(function (p) {
                d3.select("#" + biP.id)
                        ...
                        .on("click", function (d, i) {
                            return bP.clickSegment(data, p, i);
                        });
            });
        });
    }
